/**
 * The v2 conduction visual (temp preview): mounts the designed HeartVis
 * component and drives it every frame from the shared clock through the sync
 * warp — same physics, new face. Horizontal drag scrubs the clock, matching
 * the classic heart's bidirectional-scrub behavior.
 */
...
export default function HeartView2({ strip, clock, warp, blockedBranches }: Props) {
  ...
  return <div className="heart2" ref={hostRef} role="img" aria-label="Anatomical heart showing the conduction wavefront and cardiac vector" />
}
