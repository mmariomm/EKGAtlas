...
export const GUIDELINES: GuidelineEntry[] = [
  ...
  { citeKey: 'SMITH-MSC-2012', title: 'Smith-modified Sgarbossa (ST/S ratio)', org: 'Ann Emerg Med', year: 2012, scope: 'modified criteria; validated in paced rhythms', verifiedAt: '2026-08' },
