...
export const REGIONS: Region[] = [
  ...
  { id: 'LV_apex', structure: 'LV', pos: [0.4, 0.65, 0.1], dir: [0.45, 0.6, 0.05], mass: 0.3, apd: 250, seededBy: 'LAF', coupling: 12, neighbors: [{ id: 'SEPTUM', delay: 46 }, { id: 'LV_ant', delay: 36 }, { id: 'LV_lat', delay: 38 }, { id: 'LV_inf', delay: 36 }] },
  { id: 'LV_ant', structure: 'LV', pos: [0.55, 0.1, 0.45], dir: [0.45, 0.1, 0.25], mass: 0.3, apd: 245, seededBy: 'LAF', coupling: 26, neighbors: [{ id: 'LV_apex', delay: 36 }, { id: 'LV_lat', delay: 34 }] },
  { id: 'LV_lat', structure: 'LV', pos: [0.95, 0.15, -0.15], dir: [0.85, 0.1, -0.42], mass: 0.5, apd: 240, seededBy: 'LAF', coupling: 42, neighbors: [{ id: 'LV_apex', delay: 38 }, { id: 'LV_ant', delay: 34 }, { id: 'LV_inf', delay: 38 }] },
  { id: 'LV_inf', structure: 'LV', pos: [0.45, 0.6, -0.4], dir: [0.4, 0.55, -0.5], mass: 0.35, apd: 248, seededBy: 'LPF', coupling: 34, neighbors: [{ id: 'LV_apex', delay: 36 }, { id: 'LV_lat', delay: 38 }] },

  // --- right ventricle (small; anterior-rightward, faces V1) ---
  { id: 'RV_inf', structure: 'RV', pos: [-0.4, 0.6, 0.1], dir: [-0.25, 0.45, 0.15], mass: 0.14, apd: 220, seededBy: 'RBB', coupling: 12, neighbors: [{ id: 'SEPTUM', delay: 48 }, { id: 'RV_ant', delay: 44 }] },
  { id: 'RV_ant', structure: 'RV', pos: [-0.75, 0.2, 0.5], dir: [-0.6, -0.05, 0.42], mass: 0.16, apd: 210, seededBy: 'RBB', coupling: 26, neighbors: [{ id: 'RV_inf', delay: 46 }] },
]
